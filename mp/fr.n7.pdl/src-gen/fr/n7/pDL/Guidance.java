 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL.Guidance#getTexte <em>Texte</em>}</li>
 * </ul>
 *
 * @see fr.n7.pDL.PDLPackage#getGuidance()
 * @model
 * @generated
 */
public interface Guidance extends ProcessElement
{
   ...
   * @see #setTexte(String)
   * @see fr.n7.pDL.PDLPackage#getGuidance_Texte()
   * @model
   * @generated
   */
  String getTexte();
  ...
  /**
   * Sets the value of the '{@link fr.n7.pDL.Guidance#getTexte <em>Texte</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
