 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL.impl.WorkDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.pDL.impl.WorkDefinitionImpl#getLinksToPredecessors <em>Links To Predecessors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition
{
  ...
  public EList<EObject> getLinksToPredecessors()
  {
    ...
    {
      linksToPredecessors = new EObjectContainmentEList<EObject>(EObject.class, this, PDLPackage.WORK_DEFINITION__LINKS_TO_PREDECESSORS);
    }
