 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL.impl.WorkSequenceKindFinishImpl#getFinished2Start <em>Finished2 Start</em>}</li>
 *   <li>{@link fr.n7.pDL.impl.WorkSequenceKindFinishImpl#getFinished2Finish <em>Finished2 Finish</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkSequenceKindFinishImpl extends MinimalEObjectImpl.Container implements WorkSequenceKindFinish
{
  ...
  {
    return PDLPackage.Literals.WORK_SEQUENCE_KIND_FINISH;
  }
  ...
  public void setFinished2Start(String newFinished2Start)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.WORK_SEQUENCE_KIND_FINISH__FINISHED2_START, oldFinished2Start, finished2Start));
  }
  ...
  public void setFinished2Finish(String newFinished2Finish)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.WORK_SEQUENCE_KIND_FINISH__FINISHED2_FINISH, oldFinished2Finish, finished2Finish));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLPackage.WORK_SEQUENCE_KIND_FINISH__FINISHED2_START:
        return getFinished2Start();
      case PDLPackage.WORK_SEQUENCE_KIND_FINISH__FINISHED2_FINISH:
