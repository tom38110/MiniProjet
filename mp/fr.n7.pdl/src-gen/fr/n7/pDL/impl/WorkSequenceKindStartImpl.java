 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL.impl.WorkSequenceKindStartImpl#getStarted2Start <em>Started2 Start</em>}</li>
 *   <li>{@link fr.n7.pDL.impl.WorkSequenceKindStartImpl#getStarted2Finish <em>Started2 Finish</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkSequenceKindStartImpl extends MinimalEObjectImpl.Container implements WorkSequenceKindStart
{
  ...
  {
    return PDLPackage.Literals.WORK_SEQUENCE_KIND_START;
  }
  ...
  public void setStarted2Start(String newStarted2Start)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.WORK_SEQUENCE_KIND_START__STARTED2_START, oldStarted2Start, started2Start));
  }
  ...
  public void setStarted2Finish(String newStarted2Finish)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.WORK_SEQUENCE_KIND_START__STARTED2_FINISH, oldStarted2Finish, started2Finish));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLPackage.WORK_SEQUENCE_KIND_START__STARTED2_START:
        return getStarted2Start();
      case PDLPackage.WORK_SEQUENCE_KIND_START__STARTED2_FINISH:
