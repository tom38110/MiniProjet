 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL.impl.DependanceStartImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link fr.n7.pDL.impl.DependanceStartImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependanceStartImpl extends MinimalEObjectImpl.Container implements DependanceStart
{
  ...
  {
    return PDLPackage.Literals.DEPENDANCE_START;
  }
    ...
    if (predecessor != null && predecessor.eIsProxy())
    {
      ...
      if (predecessor != oldPredecessor)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDLPackage.DEPENDANCE_START__PREDECESSOR, oldPredecessor, predecessor));
      }
    }
    return predecessor;
  }
  ...
  public void setPredecessor(WorkDefinition newPredecessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.DEPENDANCE_START__PREDECESSOR, oldPredecessor, predecessor));
  }
  ...
  public NotificationChain basicSetLink(WorkSequenceKindStart newLink, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PDLPackage.DEPENDANCE_START__LINK, oldLink, newLink);
  ...
  public void setLink(WorkSequenceKindStart newLink)
  {
    if (newLink != link)
    {
      ...
      if (link != null)
        msgs = ((InternalEObject)link).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PDLPackage.DEPENDANCE_START__LINK, null, msgs);
      if (newLink != null)
        msgs = ((InternalEObject)newLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PDLPackage.DEPENDANCE_START__LINK, null, msgs);
      msgs = basicSetLink(newLink, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLPackage.DEPENDANCE_START__LINK, newLink, newLink));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PDLPackage.DEPENDANCE_START__LINK:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLPackage.DEPENDANCE_START__PREDECESSOR:
