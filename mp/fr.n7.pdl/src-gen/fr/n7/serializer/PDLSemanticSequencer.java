...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDLPackage.eINSTANCE)
			...
			case PDLPackage.DEPENDANCE_FINISH:
				sequence_DependanceFinish(context, (DependanceFinish) semanticObject); 
				return; 
			case PDLPackage.DEPENDANCE_START:
	...
	protected void sequence_DependanceFinish(ISerializationContext context, DependanceFinish semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDLPackage.Literals.DEPENDANCE_FINISH__PREDECESSOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDLPackage.Literals.DEPENDANCE_FINISH__PREDECESSOR));
			if (transientValues.isValueTransient(semanticObject, PDLPackage.Literals.DEPENDANCE_FINISH__LINK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDLPackage.Literals.DEPENDANCE_FINISH__LINK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDependanceFinishAccess().getPredecessorWorkDefinitionIDTerminalRuleCall_0_0_1(), semanticObject.eGet(PDLPackage.Literals.DEPENDANCE_FINISH__PREDECESSOR, false));
	...
	protected void sequence_DependanceStart(ISerializationContext context, DependanceStart semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDLPackage.Literals.DEPENDANCE_START__PREDECESSOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDLPackage.Literals.DEPENDANCE_START__PREDECESSOR));
			if (transientValues.isValueTransient(semanticObject, PDLPackage.Literals.DEPENDANCE_START__LINK) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDLPackage.Literals.DEPENDANCE_START__LINK));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDependanceStartAccess().getPredecessorWorkDefinitionIDTerminalRuleCall_0_0_1(), semanticObject.eGet(PDLPackage.Literals.DEPENDANCE_START__PREDECESSOR, false));
	...
	protected void sequence_Guidance(ISerializationContext context, Guidance semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDLPackage.Literals.GUIDANCE__TEXTE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDLPackage.Literals.GUIDANCE__TEXTE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 */
	protected void sequence_Process(ISerializationContext context, fr.n7.pDL.Process semanticObject) {
