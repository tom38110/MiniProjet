...
import fr.n7.generator.PDLGenerator;
import fr.n7.parser.antlr.PDLAntlrTokenFileProvider;
import fr.n7.parser.antlr.PDLParser;
import fr.n7.parser.antlr.internal.InternalPDLLexer;
import fr.n7.scoping.PDLScopeProvider;
import fr.n7.serializer.PDLSemanticSequencer;
import fr.n7.serializer.PDLSyntacticSequencer;
import fr.n7.services.PDLGrammarAccess;
import fr.n7.validation.PDLConfigurableIssueCodesProvider;
import fr.n7.validation.PDLValidator;
...
public abstract class AbstractPDLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "fr/n7/PDL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("fr.n7.PDL");
	}
